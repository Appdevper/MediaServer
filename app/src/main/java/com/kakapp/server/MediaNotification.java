...
public class MediaNotification extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.getAction().equals(MediaUpnpService.ACTION_STARTED)) {
			setupNotification(context);
		} else if (intent.getAction().equals(MediaUpnpService.ACTION_STOPPED)) {
	...
	private void setupNotification(Context context) {
		...
		Intent stopIntent = new Intent(MediaUpnpService.ACTION_STOP_SERVER);
